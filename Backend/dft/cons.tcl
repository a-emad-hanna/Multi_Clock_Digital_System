...
set_clock_groups -asynchronous  -group [get_clocks {TX_CLK RX_CLK UART_CLK}] \
				-group [get_clocks {ALU_CLK REF_CLK}] \
...
set in3_delay  [expr 0.2*$CLK3_PER]
set out3_delay  [expr 0.2*$CLK3_PER]

#Constrain Input Paths
set_input_delay $in1_delay -clock RX_CLK [get_port RX_IN]
set_input_delay $in3_delay -clock SCAN_CLK [get_port {SI SE test_mode}]
...
set_output_delay $out3_delay -clock TX_CLK [get_port SO]
...
set_driving_cell -library scmetro_tsmc_cl013g_rvt_ss_1p08v_125c -lib_cell BUFX2M -pin Y [get_ports {RX_IN test_mode SI SE}]
...
set_load 0.1 [get_ports {Stop_Error Parity_Error TX_OUT SO}]
