...
# Created by write_sdc on Mon Aug 19 03:34:03 2024
...
set_output_delay -clock TX_CLK  20  [get_ports {SO[3]}]
set_output_delay -clock TX_CLK  20  [get_ports {SO[2]}]
set_output_delay -clock TX_CLK  20  [get_ports {SO[1]}]
set_output_delay -clock TX_CLK  20  [get_ports {SO[0]}]
set_clock_groups -asynchronous -name TX_CLK_1 -group [list [get_clocks TX_CLK] [get_clocks RX_CLK] [get_clocks UART_CLK]] -group [list [get_clocks ALU_CLK] [get_clocks REF_CLK]] -group [get_clocks SCAN_CLK]
